...
(function(){
  ...
  var pity=+localStorage.getItem('fp_pity')||0; var pulls=+(localStorage.getItem('fp_pulls')||0);
  function pull(){
    ...
    localStorage.setItem('fp_pity',pity); pulls++; localStorage.setItem('fp_pulls',pulls); var pb=document.getElementById('pityBar'); if(pb) pb.textContent='soft pity '+pity+'/20 (천장 보장 없음·컴프금지)';
